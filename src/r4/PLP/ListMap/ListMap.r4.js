...
import ListView_R4 from '../ListView/ListView.r4';
...
import { PLPContainer, ListMapContainer, SidebarContainer } from '../../shared-styles/list-map.jsx';
...
class ListMapPage extends Component {
    ...
    renderCardLoader() {
        ...
        return <CardLoaderContainer className="r4-card-loader-container">{cardLoaders}</CardLoaderContainer>;
    }
    ...
    render() {
        ...
        return (
            <PLPContainer className="main plp" includePagingControls={false}>
                ...
                <ListMapContainer className="searchResults r4-list-map-container">

                    {mapViewMarkup}

                    <SidebarContainer className="r4-sidebar">
