...
class LoadingViewCommercial extends Component {
                  ...
                  <div className="cbre_container">
                    <div className="cbre_contentBySidebar">
                      <div className="paddingX-lg-1">
                        <div className="cbre_imageCarousel" data-component="image-carousel">
                          <div className="cbre_imageCarousel_items">
                            <div>
                              <div className="imageWrap imageWrap__fitWidth" data-component="image-wrap">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="cbre_sidebar cbre_sidebar__placeholder cbre_sidebar__tabletLandscapeAndUp cbre_sidebar__placeholder_top_margin">
                      <div className="row">
                      ...
                      <ul className="cbre_verticalList marginBottom-xs-1">
                        <li>
                          <div className="placeholder__contact"></div>
                        </li>
                        <li>
                          <div className="placeholder__contact"></div>
                        </li>
...
LoadingViewCommercial.contextTypes = {
    language: PropTypes.object
};

export default LoadingViewCommercial;