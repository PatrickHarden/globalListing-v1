...
class Favourite_R3 extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <a
                ...
                {isActiveClass ?         
                    <img alt="Favorite this Property" src="https://uatlistingssearchcbreeun.blob.core.windows.net/images/GL-Icons/icon-star-fill.png" /> :     
                    <img alt="Favorite this Property" src="https://uatlistingssearchcbreeun.blob.core.windows.net/images/GL-Icons/icon-star-line.png" /> 
                }
            </a>
        );
    }
...
Favourite_R3.propTypes = {
    buttonClass: PropTypes.string,
    propertyId: PropTypes.string.isRequired,
    showText: PropTypes.bool
};

export default Favourite_R3;