...
class ListView_R3 extends Component {
    ...
    renderProperty(property, isGroup, isMobile, propertyCount, propertyIndex) {
        ...
        return (
            (isGroup || isMobileCarousel || isPrerender) ?
                <PropertyCard_R3
                    ref={ref =>
...
ListView_R3.contextTypes = {
    stores: PropTypes.object,
    actions: PropTypes.object,
    spaPath: PropTypes.object
};

ListView_R3.propTypes = {
...
export default responsiveContainer(ListView_R3);
