                    ...
                    >
                        <div className="col-xs-12 col-md-12 col-lg-12 center-block">
                            <img alt="Contact for Details"
                                src="https://uatlistingssearchcbreeun.blob.core.windows.net/images/GL-Icons/icon-contact-on.png"
                                className="arrange_viewing_icon_R3"
                            />
                            <span className="cbre_button_text text_R3">
