    ...
    getContactsArray = () => {
        ...
        return truncatedContacts.map((contact, index) => {
            ...
            if (contact.telephone) {
                icons.push(
                    <img
                        src="https://uatlistingssearchcbreeun.blob.core.windows.net/images/GL-Icons/icon-phone.png"
            ...
            if (contact.email) {
                icons.push(
                    <img
                        src="https://uatlistingssearchcbreeun.blob.core.windows.net/images/GL-Icons/icon-email.png"
